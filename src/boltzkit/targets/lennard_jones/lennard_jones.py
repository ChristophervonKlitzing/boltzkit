...
class LennardJonesNew(BaseTarget, DispatchedDensityProvider, ExternalDatasetProvider):
    def __init__(
        self,
        n_particles: int,
        spatial_dims: int = 3,
...
class LennardJones(DispatchedTarget):
    ...
    def load_dataset(
        ...
        *,
        ...
        # TODO: Replace with new system in the constructor
