...
class NumpyAppendFile:
    def __init__(self, filename: str) -> None:
        ...
        Args:
            filename (str): The filename of the NumPy file.
        """
    ...
    def initialize(self, array: np.ndarray = None) -> None:
        ...
        Args:
            array (np.ndarray): The array to write if the file doesn't exist yet.
        """
    ...
    def append(self, array: np.ndarray) -> None:
        ...
        Args:
            array (np.ndarray): The array to append.
        """
    ...
    def create_header(self, padding: int = 64) -> memoryview:
        ...
        Args:
            padding (int): The padding at the end of the header to use. Must be a multiple of 64 bytes.
        """
